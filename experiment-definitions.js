...
export const experimentDefinitions = Object.freeze([
  definition({
    ...
    allowedTools: { addShape: true, size: true, color: true, position: true, rotation: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, size: true, color: true, lightness: true, position: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, size: true, position: true, rotation: true, duplicate: true, delete: true, grid: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, size: true, position: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, size: true, color: true, position: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, size: true, position: true, rotation: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, ratioSize: true, position: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, color: true, position: true, rotation: true, duplicate: true, delete: true },
  ...
  definition({
    ...
    allowedTools: { addShape: true, color: true, lightness: true, size: true, position: true, duplicate: true, delete: true },
